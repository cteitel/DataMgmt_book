...
```{r, fig.cap="Tidy data format", fig.align='center', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/tidycolumns.png")
```
...
```{r, fig.cap="Slightly less tidy data format", fig.align='center', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/speciescolumn.png")
```
