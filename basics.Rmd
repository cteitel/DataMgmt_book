...
```{r, fig.cap="Setting up defaults in R for maximum reproducibility", fig.align='center', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/workspaceimage.png")
```
