# Getting Started with R and Reproducible Workflows {#basics}
...
my_data$___
# Access the "species" column using tidyverse
pull(my_data, ___)

# BONUS: Access the count of pines
pine_row <- which(my_data$species == "___")
pine_count <- my_data[___, "count"]
print(pine_count)

# Or, do this in a "tidy" way
