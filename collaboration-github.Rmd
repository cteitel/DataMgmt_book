...
knitr::include_graphics("images/ghdesktop_publishrepo.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='90%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_newrepo.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='90%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_conflict.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='90%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_resolve.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='90%', echo = FALSE, eval = TRUE}
knitr::include_graphics("https://docs.github.com/assets/cb-141477/mw-1440/images/help/desktop/create-branch-from-commit-context-menu.webp")
```
