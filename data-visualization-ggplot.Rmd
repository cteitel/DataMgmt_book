...
```{r, fig.cap="Visualizing visualizations. (https://xkcd.com/688/)", fig.align='center', out.width='80%', echo = FALSE, eval = TRUE}
...
```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/geom_bar.png")
```
