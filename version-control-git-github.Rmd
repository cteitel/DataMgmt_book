...
```{r, fig.cap="", fig.align='left', out.width='60%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/files_with_dates.png")
```
...
```{r, fig.cap="Commit message examples", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/git_commits.png")
```

You can also easily see the changes made at each stage:

```{r, fig.cap="A diff example", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/git_changes.png")
```
...
knitr::include_graphics("images/git_schematic.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='60%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_create_repository.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_commits.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/ghdesktop_history.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/rstudio_git_setup.png")
```

```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/rstudio_git_setup2.png")
```
...
```{r, fig.cap="", fig.align='left', out.width='80%', echo = FALSE, eval = TRUE}
knitr::include_graphics("images/rstudio_git_commit2.png")
```
