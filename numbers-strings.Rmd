...
In this lesson and the following one about dates and times, we will learn basic principles on simple R objects, then apply them to columns of data frames to build on your knowledge of data managements (`mutate`, etc.).
...
![](images/stringr_funs.png)
Which of these do you want to explore more?
