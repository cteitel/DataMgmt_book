...
```{r, fig.cap='All of these parameters can be changed later. Click "Create"', fig.align='center', out.width='80%', echo = FALSE, eval = TRUE}
...
```{r, fig.cap='Two views of Quarto', fig.align='center', fig.show = 'hold', out.width='80%', echo = FALSE, eval = TRUE}
#| fig.show: "hold"
